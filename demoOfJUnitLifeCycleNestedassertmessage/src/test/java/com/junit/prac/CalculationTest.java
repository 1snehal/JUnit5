...
class CalculationTest {
	...
	class CalculationForAddTest{
		...
		void testforadditionnegative() {                           //this method execute only when the test case is failed
			int expected=-8;
			int actual=calculation.sum(-2, -6);
			assertEquals(expected,actual,()->"shuld retured sum"+expected+"but retured"+actual);
		}
	}
	@Test
